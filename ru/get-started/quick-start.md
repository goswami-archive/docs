...
3. Внести свои изменения. Правила именования файлов/каталогов, а также правила оформления текста описаны в разделах [archive-structure.md](archive-structure.md "mention") и [text-markup](../working-with-documents/text-markup/ "mention").
