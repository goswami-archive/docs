...
3. Внести свои изменения. Правила именования файлов/каталогов, а также правила оформления текста описаны в разделах [directories.md](../struktura-arkhiva/directories.md "mention") и [text-markup](../working-with-documents/text-markup/ "mention").
