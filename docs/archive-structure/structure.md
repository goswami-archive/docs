...
Файлы `.md` содержат транскрипцию соответстующих файлов аудио. Структура файла описана в разделе ["Оформление текста"](https://goswami-audio.gitlab.io/docs/docs/ru/edit/#document-structure).
...
год
  гггг_название
    язык1_гггг_Название_Книги.epub
    язык2_гггг_Название_Книги.epub
```
